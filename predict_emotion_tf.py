...
# TRILL models
SER_TRILL_MODEL_IEMOCAP = '/content/Model-CDAP/result_models/ser_trill_lstm_iemocap_model.h5'
SER_TRILL_MODEL_RAVDESS = '/content/Model-CDAP/result_models/ser_trill_lstm_ravdess_model.h5'
MER_ELECTRA_TRILL = '/content/Model-CDAP/result_models/mer_trill_electra_small_model.h5'
# Yamnet models
SER_YAMNET_MODEL_IEMOCAP = '/content/Model-CDAP/result_models/ser_yamnet_iemocap_model.h5'
SER_YAMNET_MODEL_RAVDESS = '/content/Model-CDAP/result_models/ser_yamnet_ravdess_model.h5'
MER_ELECTRA_YAMNET = '/content/Model-CDAP/result_models/mer_electra_yamnet_iemocap_model.h5'
# TER Electra
TER_ELECTRA_IEMOCAP = '/content/Model-CDAP/result_models/ter_electra_iemocap_model.h5'
TER_ELECTRA_PSYCHEXP = '/content/Model-CDAP/result_models/ter_electra_model_psychexp.h5'
